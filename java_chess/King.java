...
public class King extends Piece {
    ...
    public boolean move(int[] whereTo, Piece[][] field) {
        ...
        if ( (super.getPosition()[0] + 1 == whereTo[0] && super.getPosition()[1] == whereTo[1]) || (super.getPosition()[0] -1 == whereTo[0] && super.getPosition()[1] == whereTo[1]) || (super.getPosition()[0] == whereTo[0] && super.getPosition()[1] + 1 == whereTo[1]) || (super.getPosition()[0] == whereTo[0] && super.getPosition()[1] - 1 == whereTo[1]) || (super.getPosition()[0]+1 == whereTo[0] && super.getPosition()[1] +1 == whereTo[1]) || (super.getPosition()[0]-1 == whereTo[0] && super.getPosition()[1] +1 == whereTo[1]) || (super.getPosition()[0] +1 == whereTo[0] && super.getPosition()[1] -1 == whereTo[1]) || (super.getPosition()[0] -1 == whereTo[0] && super.getPosition()[1] -1 == whereTo[1])) {
