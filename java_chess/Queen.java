...
public class Queen extends Piece {
    ...
    public boolean move(int[] whereTo, Piece[][] field){
       boolean flag = true;
        if (whereTo[0] > super.getPosition()[0] && super.getPosition()[1] == whereTo[1]) {
            for (int i = 0; i < whereTo[0] - super.getPosition()[0] - 1; i++) {
                if (field[super.getPosition()[0] + i][super.getPosition()[1]] == null) {
                    flag = false;
                    break;
                }
            }
        } else if (whereTo[0] < super.getPosition()[0] && super.getPosition()[1] == whereTo[1]) {
            for (int i = 0; i < super.getPosition()[0] - whereTo[0] - 1; i++) {
                if (field[super.getPosition()[0] - i][super.getPosition()[1]] == null) {
                    flag = false;
                    break;
                }
            ...
            for (int i = 0; i < whereTo[1] - super.getPosition()[1] - 1; i++) {
                if (field[super.getPosition()[0]][super.getPosition()[1] + i] == null) {
                    flag = false;
                    break;
                }
            }
